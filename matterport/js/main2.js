...
+function (t) {
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                var u = r, c = this.$element.parent(), d = this.getPosition(c);
                r = "bottom" == r && p.top + p.height + f - d.scroll > d.height ? "top" : "top" == r && p.top - d.scroll - f < 0 ? "bottom" : "right" == r && p.right + h > d.width ? "left" : "left" == r && p.left - h < d.left ? "right" : r, s.removeClass(u).addClass(r)
            }
        ...
        var f = h.left ? 2 * h.left - s + l : 2 * h.top - n + p, u = h.left ? "left" : "top",
        ...
        if (this.$element.removeAttr("aria-describedby"), this.$element.trigger(s), !s.isDefaultPrevented()) return o.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? o.one("bsTransitionEnd", e).emulateTransitionEnd(150) : e(), this.hoverState = null, this
