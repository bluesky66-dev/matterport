...
$jsonData = $jsonData['model']['images'];
foreach ($jsonData as $item) {
    ...
    echo "==================================================================";
    echo '<br>';
    $destination = $_SERVER['DOCUMENT_ROOT'] . "/download/" . $folder."/".$file_name.".jpg";
    $destination1 = $_SERVER['DOCUMENT_ROOT'] . "/download/" . $folder."1/".$file_name.".jpg";
    $destination2 = $_SERVER['DOCUMENT_ROOT'] . "/download/" . $folder."2/".$file_name.".jpg";
    $destination3 = $_SERVER['DOCUMENT_ROOT'] . "/download/" . $folder."3/".$file_name.".jpg";
